...
list_treasure_chest = [
    ['ASSAULT RIFLE, MINIGUN, HEAVY SHOTGUN','TACTICAL SHOTGUN, PUMP SHOTGUN, HAND CANNON','GRAPPLER, COMPACT GUN'],
    ['1-Select a combo of weapons\n2-Dont choice a combo of weapons because we dont want to kill to our oponents','1-Select a combo of weapons\n2-Dont choice a combo of weapons and turn off the console','1-Select a combo of weapons\n2-Dont choice a combo of weapons and only collect wood'],
    ['Excellent, we have the necessary weapons to go to fight with all your opponents'],
    ['excellent decision, but to win this battle we need some weapons, lets try again'],
    ['Great. now we are on -battle royale-, the first thing we need to do is go to find some treasure.','Great we have found a treasure. lets to open it','oh wow, we have find some weapons, its time to choice which weapon we need to go to the battle.']
]

list_win_or_die = [
    ['all the squad is coming to fight with heavy weapons.','all the squad is coming to fight with only legendary weapons.','All the squad is building and castle.'],
    ...
    ['Wow, that was a great battle, the best battle ever, Congratulations now you are the winner'],
    ['That is a pity, we were so close to win. lets try again.'],
    ['Awesome, now we have all the necessary to go to the battle', '.Wow what is that? some squad is coming to you. ','Looks like that is the last squad, this will be our most important battle','1 vs 4 looks like a hard battle but we are ready to accept the challenge. what are you going to do?']
]
